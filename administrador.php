...
<html lang="en">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              ...
              <li>
                <a href="admin_boletin.php">
                  <i class="lni lni-arrow-right"></i> Boletin
                </a>
              </li>
            </ul>
          </li>
    ...
    <main class="main-wrapper">
      ...
      <section class="section">
        ...
        echo " semana: ". $week = $week2 + 1;
         ...
         $QuestSint = "SELECT COUNT(*) AS TOTAL FROM
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">ACTIVARON SINTOMAS</a></li>
    <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">COLABORADORES</a></li>
  </ul>
...
<table id="EncueXPerso" class="table">
    <thead>
        <tr>
            <th>ID</th>
            <th>NOMBRE</th>
...
<table id="ActivSinto" class="table" style="width:100%">
    <thead>
        <tr>
            <th>ID</th>
            <th>NOMBRE</th>
...
<!-- TERMINA LA TABLA -->
    ...
    <br>
<!--<button class="btn btn-success" onclick= "addcol()" >Agregar nuevo</button>-->
           </hr>
    <!-- EMPIEZA LA TABLA 3 -->

<div class="table-wrapper table-responsive">

<table id="colaboradores" class="table" style="width:100%">
    <thead>
        <tr>
            <th>ID</th>
            <th>NOMBRE</th>
...
<script src="assets/js/jquery.signaturepad.js"></script>
    ...
    <!---    sweet alert muestra formularios     -->
    <script src="funcion/js/admin_swals.js"></script>
    <!---    Funciones de fill tables      -->
